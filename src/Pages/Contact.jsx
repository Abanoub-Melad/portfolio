...
function Contact() {
                    ...
                    <div className="container">
                        ...
                        <form onSubmit={onSubmit} className="pb-5">
                            <div className="col-md-8  m-auto mt-3 ">
                                ...
                                <button
                                    type="submit"
                                    className="btnMain  d-flex m-auto my-4 px-3"
                                >
                                    send message
                                </button>
                            </div>
                        ...
                        <div className="row m-auto  text-center py-5 aboutPrg ">
	...
	C28.431,7.312,29,9.152,29,11.193C28.944,12.202,26.451,16.104,21.277,21.277z"
                                ...
                                <h5><a className="callMe" href="tel:01207525680" >01207525680</a></h5>
                            </div>
                            <div className="col-md-4 my-4">
                                <span>
                                    <svg
	...
	C10.5,10.2,10.2,11.2,10.1,12.6z"
                                ...
                                <h5>
                                    <a className="callMe"
                                        target="blank"
                                        href="mailto:Abanoubmelad328@gmail.com" >Abanoubmelad328@gmail.com</a>
                                </h5>
                            </div>
                        </div>
                    </div>
